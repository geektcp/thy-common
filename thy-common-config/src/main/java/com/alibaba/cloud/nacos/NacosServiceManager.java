...
public class NacosServiceManager {
	...
	public void onInstancePreRegisteredEvent(
		...
		if (Objects.isNull(nacosDiscoveryPropertiesCache)
			...
			copyPropertiesNoDecrypt(nacosDiscoveryProperties, nacosDiscoveryPropertiesCache);
		}
	}

	private void copyPropertiesNoDecrypt(NacosDiscoveryProperties nacosDiscoveryProperties, NacosDiscoveryProperties nacosDiscoveryPropertiesCache){
		String password = nacosDiscoveryProperties.getPassword();
		copyProperties(nacosDiscoveryProperties, nacosDiscoveryPropertiesCache);
		nacosDiscoveryPropertiesCache.setPasswordNoDecrypt(password);
